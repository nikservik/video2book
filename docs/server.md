...
+ Для результата шага добавлен режим редактирования через `Trix`: в режиме просмотра показывается кнопка `Редактировать`, в режиме редактирования — кнопки `Назад` и `Сохранить`
