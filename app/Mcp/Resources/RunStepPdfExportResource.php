...
#[Name('run-step-pdf-export')]
#[MimeType('application/pdf')]
#[Description('Возвращает результат шага прогона в формате PDF.')]
class RunStepPdfExportResource extends Resource implements HasUriTemplate
{
    ...
    {
        return new UriTemplate('video2book://pipeline-runs/{run_id}/steps/{step_id}/export/pdf');
    }
    ...
    public function handle(Request $request): Response
    {
        ...
        return Response::blob($this->pipelineStepPdfExporter->export($run, $step));
    }
}
