...
#[Name('project-single-file-docx-export')]
#[MimeType('application/vnd.openxmlformats-officedocument.wordprocessingml.document')]
#[Description('Возвращает единый DOCX-файл экспорта проекта по выбранной версии шаблона и шагу.')]
class ProjectSingleFileDocxExportResource extends Resource implements HasUriTemplate
{
    ...
    public function uriTemplate(): UriTemplate
    {
        return new UriTemplate(
            'video2book://projects/{project_id}/exports/{pipeline_version_id}/{step_version_id}/single-file/docx'
        );
    }
