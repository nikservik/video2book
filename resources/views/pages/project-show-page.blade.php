<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
                        ...
                        <article wire:key="lesson-row-{{ $lesson->id }}"
                            ...
                            <div class="flex items-start justify-between gap-3">
                                ...
                                <div class="mt-px flex items-center gap-1">
                                    <button type="button"
                                            wire:click="openAddPipelineToLessonModal({{ $lesson->id }})"
        ...
        <aside class="lg:col-span-1">
            <div class="space-y-3">
                ...
                <button type="button"
                        wire:click="openProjectExportModal('pdf')"
                ...
                <button type="button"
                        wire:click="openProjectExportModal('md')"
    ...
    @if ($showAddPipelineToLessonModal)
        <div class="fixed inset-0 z-50 overflow-y-auto" role="dialog" aria-modal="true" data-add-pipeline-to-lesson-modal>
            <div class="fixed inset-0 bg-gray-500/75 transition-opacity dark:bg-gray-900/50" wire:click="closeAddPipelineToLessonModal"></div>
                ...
                <div class="relative transform overflow-hidden rounded-lg bg-white px-4 pt-5 pb-4 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-6 dark:bg-gray-800 dark:outline dark:-outline-offset-1 dark:outline-white/10"
                    ...
                    <form wire:submit="addPipelineToLesson" class="space-y-5">
                        ...
                        <div class="mt-10 sm:flex sm:flex-row-reverse">
                            ...
                            <button type="button" wire:click="closeAddPipelineToLessonModal"
                                    class="mt-3 inline-flex w-full justify-center rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-xs inset-ring-1 inset-ring-gray-300 hover:bg-gray-50 sm:mt-0 sm:w-auto dark:bg-white/10 dark:text-white dark:shadow-none dark:inset-ring-white/5 dark:hover:bg-white/20">
                                Отменить
                            </button>
                        </div>
    ...
    @if ($showProjectExportModal)
        <div class="fixed inset-0 z-50 overflow-y-auto" role="dialog" aria-modal="true" data-project-export-modal>
            <div class="fixed inset-0 bg-gray-500/75 transition-opacity dark:bg-gray-900/50" wire:click="closeProjectExportModal"></div>
                ...
                <div class="relative transform overflow-hidden rounded-lg bg-white px-4 pt-5 pb-4 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-2xl sm:p-6 dark:bg-gray-800 dark:outline dark:-outline-offset-1 dark:outline-white/10"
                    ...
                    <form wire:submit="downloadProjectResults" class="space-y-5">
                        ...
                        <div class="mt-10 sm:flex sm:flex-row-reverse">
                            ...
                            <button type="button" wire:click="closeProjectExportModal"
                                    class="mt-3 inline-flex w-full justify-center rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-xs inset-ring-1 inset-ring-gray-300 hover:bg-gray-50 sm:mt-0 sm:w-auto dark:bg-white/10 dark:text-white dark:shadow-none dark:inset-ring-white/5 dark:hover:bg-white/20">
                                Отменить
                            </button>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="mt-2" wire:replace>
                                <el-select id="project-default-pipeline-version"
                                           ...
                                           value="{{ (string) ($editableProjectDefaultPipelineVersionId ?? '') }}"
                                           wire:model.live="editableProjectDefaultPipelineVersionId"
                                           class="block">
                                    <button type="button"
                                            class="grid w-full cursor-default grid-cols-1 rounded-md bg-white py-1.5 pr-2 pl-3 text-left text-gray-900 outline-1 -outline-offset-1 outline-gray-300 focus-visible:outline-2 focus-visible:-outline-offset-2 focus-visible:outline-indigo-600 sm:text-sm/6 dark:bg-white/5 dark:text-white dark:outline-white/10 dark:focus-visible:outline-indigo-500">
                                        <el-selectedcontent class="col-start-1 row-start-1 truncate pr-6">{{ $this->selectedEditableProjectDefaultPipelineVersionLabel }}</el-selectedcontent>
                                        <svg viewBox="0 0 16 16" fill="currentColor" aria-hidden="true"
                                             class="col-start-1 row-start-1 size-5 self-center justify-self-end text-gray-500 sm:size-4 dark:text-gray-400">
                                            <path d="M5.22 10.22a.75.75 0 0 1 1.06 0L8 11.94l1.72-1.72a.75.75 0 1 1 1.06 1.06l-2.25 2.25a.75.75 0 0 1-1.06 0l-2.25-2.25a.75.75 0 0 1 0-1.06ZM10.78 5.78a.75.75 0 0 1-1.06 0L8 4.06 6.28 5.78a.75.75 0 0 1-1.06-1.06l2.25-2.25a.75.75 0 0 1 1.06 0l2.25 2.25a.75.75 0 0 1 0 1.06Z" clip-rule="evenodd" fill-rule="evenodd"/>
                                        </svg>
