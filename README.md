...
- На странице проекта в правом блоке доступны кнопки экспорта результатов в `PDF`, `MD` и `DOCX` (через общий modal выбора версии пайплайна и шага с последующей загрузкой ZIP-архива).
