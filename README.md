...
- Верхнее меню содержит разделы `Главная`, `Проекты`, `Пайплайны`, `Пользователи`; видимость пунктов зависит от `access_level`, а активный пункт определяется по имени роута (`routeIs`).
