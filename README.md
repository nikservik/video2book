...
- В блоке результата шага добавлен режим редактирования через `Trix`: над контентом справа доступны иконки `Редактировать` (в режиме просмотра) и `Назад/Сохранить` (в режиме редактирования).
