...
class HomePageTest extends TestCase
{
    ...
    public function test_home_page_renders_expected_content_and_controls(): void
    {
        ...
        $response
            ...
            ->assertSee('Последние обновления')
            ->assertSee('11 марта 2026')
            ->assertSee('Проект теперь можно скачивать одним большим файлом')
            ->assertSee('Тестовый режим MCP сервера, чтобы можно было работать из Gemini')
